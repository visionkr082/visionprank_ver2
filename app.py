...
def find_rank(index, keyword, place_id):
    ...
    try:
        ...
        try:
            driver.execute_script("window.scrollBy(0, 700);")  # 스크롤 아래로
            print("스크롤을 700px 내렸습니다.")
...
def save_to_excel():
    try:
        ...
        excel_path = f"C:/Users/82105/Downloads/visionprank-master/data/keywords_backup_{now}.xlsx"
